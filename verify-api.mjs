...
if (sampleMode) {
  ...
  validateCodexUsage({ ...sampleCodexUsageConfigured(), source: "live" });
...
function validateCodexUsage(usage) {
  ...
  assert(["sessions", "live", "none"].includes(usage.source), `codexUsage.source = ${usage.source}, want sessions|live|none`);
